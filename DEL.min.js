...
(a&&a.clientLeft||b&&b.clientLeft||0),this.pageY=this.clientY+(a&&a.scrollTop||b&&b.scrollTop||0)-(a&&a.clientTop||b&&b.clientTop||0));if(null==this.which&&(null!=this.charCode||null!=this.keyCode))this.which=null!=this.charCode?this.charCode:this.keyCode;!this.metaKey&&this.ctrlKey&&(this.metaKey=this.ctrlKey);!this.which&&void 0!==this.button&&(this.which=this.button&1?1:this.button&2?3:this.button&4?2:0)}function r(a,b,c,d){b=b.replace(B,"");d={type:c,fn:d,sel:b,on:!0};if(b.match(J))d.id=RegExp.$1;
else if(b=b.split("."),b[0]&&"*"!=b[0]&&(d.tag=b[0].toUpperCase()),1<b.length)d.mod=b.slice(1);c=j.map[c]||c;(a[c]=a[c]||[]).push(d)}function C(a,b){var c;i(b,function(d,e){if("fn"!=e&&(c="__on"+e,b.fn[c]&&!d.length&&(b.fn[c]=0,y(a,!1,e,b.fn)),!b.fn[c]&&d.length))b.fn[c]=1,y(a,!0,e,b.fn)})}function D(a,b,c,d){k(a)&&!c?(d=b,b=a,c="*",a=l):!k(a)&&k(b)&&!d&&(d=c,c="*");b?c&&!d&&(d=c,c=b,b=a,a=l):(b=a,a=l);a=a||n.body;if(k(b)){var e={};e["["+b+"] "+c]=d;b=e}i(a,function(a){var c=a.uniqId||(a.uniqId=++K),
d=o[c]=o[c]||{},e;i(b,function(a,b){if(e=b.match(E)){b=b.replace(E,"");i(j.split(e[1]),function(c){i(b.split(","),function(b){r(d,b,c,a)})})}else q.call(a)=="[object Object]"?i(a,function(a,c){i(b.split(","),function(b){i(j.split(c),function(c){r(d,b,c,a)})})}):r(d,b,"click",a)});if(!d.fn)d.fn=function(b){a:{var b=j.fix(b||p.event),d,e,i=b.type,m=b.target,f,g=o[c][i],h;d=b.originalEvent;if(i===F&&!("delta"in b)){if(d.wheelDelta)b.delta=d.wheelDelta/120;if(d.detail)b.delta=-d.detail/3}if(g&&g.length)for(;m!==
null&&m!==a;){if(m.nodeType==1){d=0;for(e=g.length;d<e;d++){f=g[d];if(f.on&&I(m,f)){h=j.special[f.type];if(h===l||h(b,m)){b.type=f.type;b.currentTarget=m;if(f.fn.call(m,b)===false){b.preventDefault();b.stopPropagation()}b.type=i;if(b.isPropagationStopped())break a}}}}m=m.parentNode}}};C(a,d)})}function g(a,b,c,d,e){if("[object Boolean]"==q.call(a))var f=e,e=a,a=b,b=c,c=d,d=f;k(a)&&(d=c,c=b,b=a,a=n.body);"[object Function]"==q.call(c)||"[object Boolean]"==q.call(d)||c===l?(g(a,b,"",c,e),g(a,"",b,c,
e)):i(a,function(a){if(a.uniqId&&o[a.uniqId]){var f=o[a.uniqId],g,h,n;i(f,function(k,o){if(o!=="fn"){for(g=k.length;g--;){h=k[g];i(j.split(b),function(a){if(n=(!a||a==h.type)&&(!d||d===h.fn)&&(!c||c.toLowerCase()==h.sel.toLowerCase()))e!==l?h.on=!e:k=k.slice(0,g).concat(k.slice(g+1))})}f[o]=k;C(a,f)}})}})}var J=/#([^\.]+)/i,K=1,o={},h="prototype",w=Array[h].slice,q=Object[h].toString,x=Function[h].bind,L=/(^\s+|\s+$)/g,B=/\s+/g,E=/^\[([^\]]+)\]\s*/i,G=function(){},n=p.document,F="onmousewheel"in n?
...
focus:"focusin",mouseenter:"mouseover",mouseleave:"mouseout",mousewheel:F},group:{hover:"mouseenter mouseleave",mouseclick:"mouseup mousedown"},special:{mouseenter:u,mouseleave:u},split:function(a){a=(" "+a+" ").replace(/\s([^\s]+)/,function(a,c){return" "+(j.group[c]||c)});return a.replace(L,"").split(B)},add:function(a,b,c){c?(j.map[a]=b,j.special[a]=c):j.group[a]=b}};A[h]={preventDefault:function(){this.isDefaultPrevented=s;var a=this.originalEvent;a.preventDefault?a.preventDefault():a.returnValue=
!1},stopPropagation:function(){this.isPropagationStopped=s;var a=this.originalEvent;a.stopPropagation&&a.stopPropagation();a.cancelBubble=!0},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=s;this.stopPropagation()},isDefaultPrevented:t,isPropagationStopped:t,isImmediatePropagationStopped:t};f&&(j.fix=function(a){return a},j.props=f.event.props,f.fn.listen=function(a,b,c){D(this,a,b,c);return this},f.fn.unlisten=function(a,b,c){g(this,a,b,c);return this},f.fn.muteListen=function(a,
b,c){g(this,a,b,c,!0);return this},f.fn.unmuteListen=function(a,b,c){g(this,a,b,c,!1);return this});p.DEL={on:D,off:g,mute:v(G,g,!0),unmute:v(G,g,!1),event:j}})(this,this.jQuery);window.ajs&&ajs.loaded&&ajs.loaded("{DEL}DEL.min");"function"===typeof define&&define.amd&&define("DEL",[],function(){return window.DEL||{}});
